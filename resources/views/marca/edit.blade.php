        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white shadow-sm sm:rounded-lg bg-div">
                <div class="p-6 text-gray-900">
                    ...
                    <form class="guardar" action="{{ route('marcas.update', $marca->id) }}" method="POST"
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            <div>
                                ...
                                <x-text-input id="nombre_marca" class="block mt-1 w-full" type="text"
                                    name="nombre_marca" :value="old('nombre_marca', $marca->nombre_marca)" required
                            ...
                            <div class="mb-2">
                                ...
                                <div id="drop-area" class="mt-1 border-2 border-dashed border-gray-300 rounded-lg p-1 
                                    ...
                                    <div id="drop-content" class="{{ $marca->foto_marca ? 'hidden' : '' }}">
                                        ...
                                        <p class="mt-1 text-sm text-gray-600">Arrastra un nuevo logo</p>
                                        <p class="mt-1 text-xs text-gray-500">o haz clic para seleccionar (opcional)</p>
                                        <input type="file" id="foto_marca" name="foto_marca" class="hidden"
                                            accept="image/*" />
                                    </div>

                                    <div id="preview-container" class="{{ $marca->foto_marca ? '' : 'hidden' }}">
                                        @if($marca->foto_marca)
                                            <img id="foto_preview" src="{{ asset('storage/' . $marca->foto_marca) }}"
                                                alt="Logo actual" class="mx-auto max-w-full h-auto rounded-lg"
                                                style="max-height: 150px;">
                                            <p id="file-name" class="mt-2 text-sm text-gray-600 text-center">Logo actual</p>
                                        @else
